...
export type AccumulatorOperator<R = AnyVal> = (collection: RawObject[], expr: AnyVal, options: Options) => R;
export type ExpressionOperator<R = AnyVal> = (obj: RawObject, expr: AnyVal | RawObject | RawArray, options: Options) => R;
